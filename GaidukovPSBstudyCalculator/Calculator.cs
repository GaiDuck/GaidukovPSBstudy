...
{
    internal class Calculator //Класс такого рода - стиль функционального программирования, переименовать в название для объекта, к примеру: Calculator
    {
        ...
        /// Подумать, точно ли здесь должен быть вообще TempResult? Если это из-за того, что он нужен где-то в другом методе с использованием этого метода, 
        /// то лучше уж там сделать TempResult = Add(...), а здесь оставить return firNumber + secondNumber
        /// </summary>
        /// <param name="firstNumber"></param>
        /// <param name="secondNumber"></param>
        /// <returns></returns>
        double Addiction(double firstNumber, double secondNumber)
        {
